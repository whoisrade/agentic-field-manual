...
Prerequisites:
- [Auditability Gap](../failure-modes/auditability-gap.md) - why logging isn't enough
- [Auditability](../compliance/auditability.md) - what evidence you need
...
See: Use [Traceability Checklist](../templates/traceability-checklist.md) before shipping
See: Reference [Auditability](../compliance/auditability.md) for the requirements
