...
Prerequisites:
- [State Model](../irreversible-decisions/state-model.md) - the foundational principles
...
See: Use [Decision Log](../templates/decision-log.md) before committing to a state model
See: Reference [State Model](../irreversible-decisions/state-model.md) for the principles
