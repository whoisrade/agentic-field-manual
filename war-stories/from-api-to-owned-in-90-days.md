...
Prerequisites:
- [API vs Owned](../economics/api-vs-owned.md) - the decision framework
- [Margin Fragility](../failure-modes/margin-fragility.md) - why this matters for unit economics
- [Capacity Planning](../economics/capacity-planning.md) - forecasting demand for AI workloads
...
See: Use [Decision Log](../templates/decision-log.md) before committing to infrastructure ownership
See: Reference [API vs Owned](../economics/api-vs-owned.md) for the framework
