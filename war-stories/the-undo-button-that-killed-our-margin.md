...
Prerequisites:
- [Control Surface Drift](../failure-modes/control-surface-drift.md) - why UX shapes compute costs
- [Hidden Recompute](../economics/hidden-recompute.md) - detecting invisible cost drivers
- [Interaction Contract](../irreversible-decisions/interaction-contract.md) - defining what users can trigger
...
See: Use [Cost Model](../economics/cost-model.md) to instrument by trigger type
See: Run [System Drift Review](../templates/system-drift-review.md) to find your hidden undo button
